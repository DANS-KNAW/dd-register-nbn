...
2. Extract it to some location on your system, for example `/opt/dans.knaw.nl/dd-register-nbn`.
3. Start the service with the following command
   ```
   /opt/dans.knaw.nl/dd-register-nbn/bin/dd-register-nbn server /opt/dans.knaw.nl/dd-register-nbn/cfg/config.yml 
   ```
